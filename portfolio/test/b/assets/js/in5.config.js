...
function initWebApp(){
	...
	if(isDevice){
		...
		var sendLinkURL = 'https://sinnyunki.github.io/' + 
		(location.protocol == 'file:' ? 'sinnyunki/DigitalPublishing/' : location.href) +'"><img style="display: block; margin: 0 auto; " src="assets/images/non_mobile.png'   ; 
        
        
		$('body').append('<a href="'+sendLinkURL+'  " /></a>').find('#container-wrap')
		return !0;
	}
	return !1;
}
