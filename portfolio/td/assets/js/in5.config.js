...
function initWebApp(){
	...
	if(isDevice){
		...
		(location.protocol == 'file:' ? 'sinnyunki/DigitalPublishing/' : location.href) +'"><img style="display: block; margin: 0 auto; " src="assets/images/non_'+nameForNonDeviceFile+'.jpg';
